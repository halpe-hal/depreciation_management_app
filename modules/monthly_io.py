...
from db.all_expense_total_depreciation import get_expense_totals
from modules.expense_tables import show_expense_tables_by_select
from db.fixed_categories import apply_fixed_expenses
from db.all_expense_depreciation import update_expense_totals_by_category
...
# --- 出金管理 ---
def handle_all_expense_depreciation(year: int, month: int, top_category: str):
...
def show_monthly_io():
    ...
    if io_type == "入金":
        ...
        handle_all_expense_depreciation(year, month, top_category)
